...
console.log(`Word "they" exist in message or not`);
...
console.log(`Word "is" exist in message or not`);
...
console.log(`Word from index 3 to 6 is "you" or not (use slice)`);
...
console.log(`Word from index 7 to 8 is "a" or not`);
...
console.log(message.slice(message.length-3)==="no!"?`last 3 character in message are "no!"`:`last 3 character in message are not "no!"`);

// Check and log whether the last 5 character in message is "no!" or not
console.log(message.slice(message.length-5)==="no!"?`last 5 character in message are "no!"`:`last 5 character in message are not "no!"`);
